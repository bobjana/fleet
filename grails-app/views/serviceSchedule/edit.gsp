...
<html>
    <head>
        ...
        <title><g:message code="default.edit.label" args='[entityName, "${serviceScheduleInstance}"]' default="Edit ServiceSchedule - ${' ' + serviceScheduleInstance}" encodeAs="HTML" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="default.edit.label" args='[entityName, "${serviceScheduleInstance}"]' default="Edit ServiceSchedule - ${' ' + serviceScheduleInstance}" encodeAs="HTML"/></h1>
            ...
            <g:form controller="serviceSchedule" >
                <fieldset>
                <g:hiddenField name="id" value="${serviceScheduleInstance?.compositeId}" />
                <g:hiddenField name="version" value="${serviceScheduleInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
